    ...
    <div className="space-y-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="from-brand-500 to-accent-violet shadow-glow flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br text-lg font-bold text-white">
        ...
        <button
          ...
          className="surface focus-ring inline-flex items-center gap-1.5 rounded-full px-3 py-2 text-xs font-semibold"
        >
            ...
            {favorites.map((f) => {
              ...
              return (
                <li key={f.id} className="flex items-center gap-3 px-4 py-3">
                  <Heart className="text-status-severe h-4 w-4" />
                  <div className="flex-1">
                    <div className="text-sm font-semibold">
                      {f.label ?? place?.name ?? f.placeId}
                    </div>
                    <div className="text-subtle text-xs uppercase tracking-wide">{f.kind}</div>
                  </div>
                  <button
              ...
              <li key={r.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1">
                  ...
                  {r.notifyOnDisruption && (
                    <div className="text-status-onTime text-xs">Notify on disruption</div>
                  )}
                </div>
              </li>
            ))}
...
function EmptyFavorites() {
  return (
    <div className="surface text-muted rounded-2xl p-6 text-center text-sm">
