...
export default function PrivacyPage() {
  return (
    <>
      <SiteHeader />
      <main className="prose-invert mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <h1 className="text-3xl font-bold">Privacy</h1>
        <p className="text-muted mt-3 text-sm">
          Last updated: {new Date().toISOString().slice(0, 10)}
        </p>

        <section className="text-muted mt-8 space-y-3 text-sm leading-relaxed">
          ...
          <p>
            ...
            email, display name, preferred locale and theme, a bcrypt hash of your password, and (if
            you opt in) push subscription endpoints + your notification channel preferences.
          </p>
          <p>
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              Export: <code>GET /api/me/export</code> returns all your records as JSON (planned).
            </li>
            <li>
              Delete: <code>DELETE /api/auth/me</code> wipes your account and cascades to all
              related rows.
            </li>
            <li>
          ...
          <p>
            For DSGVO requests, email{' '}
            <a className="text-brand-500" href="mailto:privacy@wayra.app">
              privacy@wayra.app
            </a>
            .
          </p>
